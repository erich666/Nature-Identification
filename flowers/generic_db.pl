...
@referers = ('www.realtimerendering.com','209.0.200.250','www.acm.org');
...
<hr>
<I><a href="http://www.acm.org/tog/editors/erich/">Eric Haines</a>,
...
sub list_object {
	...
	$fnameplus = "'" . $fnameplus . "'";	# quotes around it works better yet
